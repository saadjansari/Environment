...
os.chdir('build')
os.system('bash ../do-configure-TRNG4.sh && make -j8')
...
os.system('rm -rf ./build && mkdir ./build')
os.chdir('build')
os.system('bash ../do-configure-YamlCpp.sh && make -j8')
if install:
    os.system('make install')
...
os.system('rm -rf ./build && mkdir ./build')
os.chdir('build')
os.system('bash ../do-configure-MsgPack.sh && make -j8')
if install:
    os.system('make install')
...
os.system('rm -rf ./build && mkdir ./build')
os.chdir('build')
os.system('bash ../do-configure-Eigen.sh && make -j8')
if check_eigen:
...
os.system('rm -rf ./build && mkdir ./build')
os.chdir('build')
os.system('bash ../do-configure-Trilinos.sh && make -j8')
if test_Trilinos:
